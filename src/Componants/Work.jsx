        ...
        <section className="marginControl" id="work">
            <div className="flex justify-end w-full px-10 gap-7">
                <div ref={project1Ref} className="flex-col-left basis-6/10 ">
                    <img src="/images/project1.png" alt="Project-1 Image" className="border-1 border-white rounded-xl" />
                    <div>
                        <p className="heading">Block Busters</p>
                        <p className="txt">Block-Busters is a Cape Town-based company offering professional drain and sewer cleaning, pipe repairs, and trenchless solutions for residential and commercial properties.</p>
                ...
                <div className="flex-col-left basis-4/10 gap-5">
                    <div ref={project2Ref}>
                        <img src="/images/project2.png" alt="Project-2 Image" className="border-1 border-white rounded-xl"/>
                        <div>
                    ...
                    <div ref={project3Ref}>
                        <img src="/images/project3.png" alt="Project-3 Image" className="border-1 border-white rounded-xl"/>
                        <div>
